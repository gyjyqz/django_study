    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key_words', models.CharField(blank=True, max_length=1024, null=True)),
                ...
                ('user', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='articles_user_set', to='articles.User')),
            ],
            options={
                'db_table': 'articles',
            },
